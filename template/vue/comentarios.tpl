    ...
    {literal}
        <div id="tabla-comentarios" class="container">
            ...
            <div>
                ...
                <button type="submit" v-on:click="ordenar('fecha','ASC')" class="btn btn-info">fecha asc</button>
                <button type="submit" v-on:click="ordenar('fecha','DESC')" class="btn btn-info">fecha des</button>
                <button type="button" v-on:click="ordenar('puntuacion','ASC')" class="btn btn-info">calificacion asc</button>
                <button type="button" v-on:click="ordenar('puntuacion','DESC')" class="btn btn-info">calificacion des</button>
            </div>
